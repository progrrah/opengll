 ...
 * and this permission2 notice appear in supporting documentation, and that
...
void TexFunc(void) {
...
#if GL_EXT_abgr
  glTexImage2D(GL_TEXTURE_2D, 0, 3, 128, 128, 0, GL_ABGR_EXT, GL_UNSIGNED_BYTE,
               ubImage);
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, 3, 128, 128, 0, GL_RGBA, GL_UNSIGNED_BYTE,
               ubImage);
